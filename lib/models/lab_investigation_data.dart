class LabInvestigationResponse {
  int? status;
  String? errorMessage;
  Data? data;

  LabInvestigationResponse({this.status, this.errorMessage, this.data});

  LabInvestigationResponse.fromJson(Map<String, dynamic> json) {
    status = json['Status'];
