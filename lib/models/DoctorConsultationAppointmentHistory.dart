...
class DoctorConsultationAppointmentHistory {
  ...
  DoctorConsultationAppointmentHistory.fromJson(Map<String, dynamic> json) {
    Status = json['Status'];
    Data = List.from(json['Data'])
        .map((e) => DoctorConsultationAppointmentHistoryDataList.fromJson(e))
        .toList();
...
class DoctorConsultationAppointmentHistoryDataList {
  ...
  DoctorConsultationAppointmentHistoryDataList.fromJson(
