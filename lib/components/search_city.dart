...
searchableCity(BuildContext context, List<Cities> list
                  ...
                  child: Column(
                    children: [
                      ...
                      list.isNotEmpty
                                ...
                                itemBuilder: ((context, index) {
                                  if (search.text.isEmpty) {
                                    return InkWell(
                                      onTap: () {
                                        generic = list[index];
                                        AuthController.i.updateCity(generic!);
                          ...
                          : Padding(
                              padding:
                                  const EdgeInsets.all(10).copyWith(top: 20),
